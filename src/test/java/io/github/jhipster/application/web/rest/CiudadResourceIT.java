...
public class CiudadResourceIT {
    ...
    private static final String DEFAULT_CODIGO_CIUDAD = "AAAAAAAAAA";
    private static final String UPDATED_CODIGO_CIUDAD = "BBBBBBBBBB";
    ...
    public static Ciudad createEntity(EntityManager em) {
        Ciudad ciudad = new Ciudad()
            ...
            .codigoCiudad(DEFAULT_CODIGO_CIUDAD);
        return ciudad;
    }
    /**
    ...
    public static Ciudad createUpdatedEntity(EntityManager em) {
        Ciudad ciudad = new Ciudad()
            ...
            .codigoCiudad(UPDATED_CODIGO_CIUDAD);
        return ciudad;
    }
    ...
    public void createCiudad() throws Exception {
        ...
        assertThat(testCiudad.getCodigoCiudad()).isEqualTo(DEFAULT_CODIGO_CIUDAD);
    ...
    public void getAllCiudads() throws Exception {
        ...
        restCiudadMockMvc.perform(get("/api/ciudads?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].codigoCiudad").value(hasItem(DEFAULT_CODIGO_CIUDAD.toString())));
    }
    ...
    public void getCiudad() throws Exception {
        ...
        restCiudadMockMvc.perform(get("/api/ciudads/{id}", ciudad.getId()))
            ...
            .andExpect(jsonPath("$.codigoCiudad").value(DEFAULT_CODIGO_CIUDAD.toString()));
    }
    ...
    @Test
    @Transactional
    public void getAllCiudadsByCodigoCiudadIsEqualToSomething() throws Exception {
        // Initialize the database
        ciudadRepository.saveAndFlush(ciudad);

        // Get all the ciudadList where codigoCiudad equals to DEFAULT_CODIGO_CIUDAD
        defaultCiudadShouldBeFound("codigoCiudad.equals=" + DEFAULT_CODIGO_CIUDAD);

        // Get all the ciudadList where codigoCiudad equals to UPDATED_CODIGO_CIUDAD
        defaultCiudadShouldNotBeFound("codigoCiudad.equals=" + UPDATED_CODIGO_CIUDAD);
    }

    @Test
    @Transactional
    public void getAllCiudadsByCodigoCiudadIsInShouldWork() throws Exception {
        // Initialize the database
        ciudadRepository.saveAndFlush(ciudad);

        // Get all the ciudadList where codigoCiudad in DEFAULT_CODIGO_CIUDAD or UPDATED_CODIGO_CIUDAD
        defaultCiudadShouldBeFound("codigoCiudad.in=" + DEFAULT_CODIGO_CIUDAD + "," + UPDATED_CODIGO_CIUDAD);

        // Get all the ciudadList where codigoCiudad equals to UPDATED_CODIGO_CIUDAD
        defaultCiudadShouldNotBeFound("codigoCiudad.in=" + UPDATED_CODIGO_CIUDAD);
    }

    @Test
    @Transactional
    public void getAllCiudadsByCodigoCiudadIsNullOrNotNull() throws Exception {
        // Initialize the database
        ciudadRepository.saveAndFlush(ciudad);

        // Get all the ciudadList where codigoCiudad is not null
        defaultCiudadShouldBeFound("codigoCiudad.specified=true");

        // Get all the ciudadList where codigoCiudad is null
        defaultCiudadShouldNotBeFound("codigoCiudad.specified=false");
    }
    ...
    private void defaultCiudadShouldBeFound(String filter) throws Exception {
        restCiudadMockMvc.perform(get("/api/ciudads?sort=id,desc&" + filter))
            ...
            .andExpect(jsonPath("$.[*].codigoCiudad").value(hasItem(DEFAULT_CODIGO_CIUDAD)));
    ...
    public void updateCiudad() throws Exception {
        ...
        assertThat(testCiudad.getCodigoCiudad()).isEqualTo(UPDATED_CODIGO_CIUDAD);

...
public class PaisResourceIT {
    ...
    public void getAllPais() throws Exception {
        ...
        restPaisMockMvc.perform(get("/api/pais?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].codigoPais").value(hasItem(DEFAULT_CODIGO_PAIS.toString())));
    }
    ...
    public void getPais() throws Exception {
        ...
        restPaisMockMvc.perform(get("/api/pais/{id}", pais.getId()))
            ...
            .andExpect(jsonPath("$.codigoPais").value(DEFAULT_CODIGO_PAIS.toString()));
    }
    ...
    @Test
    @Transactional
    public void getAllPaisByCodigoPaisIsEqualToSomething() throws Exception {
        // Initialize the database
        paisRepository.saveAndFlush(pais);
    ...
    @Test
    @Transactional
    public void getAllPaisByCodigoPaisIsInShouldWork() throws Exception {
        // Initialize the database
        paisRepository.saveAndFlush(pais);
    ...
    @Test
    @Transactional
    public void getAllPaisByCodigoPaisIsNullOrNotNull() throws Exception {
        // Initialize the database
        paisRepository.saveAndFlush(pais);

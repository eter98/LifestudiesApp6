...
import { AgenciaComponent } from 'app/entities/agencia/agencia.component';
import { AgenciaService } from 'app/entities/agencia/agencia.service';
import { Agencia } from 'app/shared/model/agencia.model';

describe('Component Tests', () => {
  describe('Agencia Management Component', () => {
    let comp: AgenciaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AgenciaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.agencias[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

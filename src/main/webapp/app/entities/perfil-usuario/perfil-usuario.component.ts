...
export class PerfilUsuarioComponent implements OnInit, OnDestroy {
  ...
  registerChangeInPerfilUsuarios() {
    this.eventSubscriber = this.eventManager.subscribe('perfilUsuarioListModification', response => this.reset());
  }
  ...
  protected paginatePerfilUsuarios(data: IPerfilUsuario[], headers: HttpHeaders) {
